    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col items-start gap-12">
        ...
        <div className="mt-6 w-full">
          ...
          <div className="mt-8 w-full text-left space-y-4 max-w-md">
            <h2 className="text-3xl font-extrabold text-neutral-900 mb-4">Our Features</h2>
            <ul className="space-y-4">
              <li>
                <h4 className="font-semibold text-lg text-green-600">Eco-Friendly Products</h4>
                <p className="text-gray-600">Safe for your family and pets.</p>
              </li>
              <li>
                <h4 className="font-semibold text-lg text-green-600">Professional Team</h4>
                <p className="text-gray-600">Trained and certified staff.</p>
              </li>
              <li>
                <h4 className="font-semibold text-lg text-green-600">24/7 Service</h4>
